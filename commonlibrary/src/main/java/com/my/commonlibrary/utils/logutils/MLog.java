package com.my.commonlibrary.utils.logutils;

import android.text.TextUtils;
import android.util.Log;

import com.my.commonlibrary.utils.CommonConstants;


public class MLog {

    public static boolean LOG = CommonConstants.LOG;
    public static String TAG_ROOT = CommonConstants.LOG_TAG;
    ...
    public static void json(int logLevel, String tag, String json) {
        if (LOG) {
            ...
            MPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatJson);
        }
    }
    ...
    public static void xml(int logLevel, String tag, String xml) {
        if (LOG) {
            ...
            MPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatXml);
        }
    }
    ...
    public static void error(String tag, Throwable throwable) {
        if (LOG) {
            ...
            MPrinter.println(Log.ERROR, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatError);
        }
    }
    ...
    private static void msg(int logLevel, String tag, String format, Object... args) {
        if (LOG) {
            ...
            MPrinter.println(logLevel, TextUtils.isEmpty(tag) ? TAG_ROOT : tag, formatMsg);
        }
    }
