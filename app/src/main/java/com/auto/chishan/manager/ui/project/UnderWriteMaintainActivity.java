...
import com.auto.chishan.manager.adapter.UnderwriteMaintainAdapter;
import com.auto.chishan.manager.bean.UnderwriteMaintainBean;
import com.auto.chishan.manager.bean.UnderwriteMaintainDataBean;
 ...
 * @author:DingZhixiang
 */
public class UnderWriteMaintainActivity extends BaseResultActivity {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    @BindView(R.id.smartRefresh_view)
    SmartRefreshLayout smartRefreshView;

    private UnderwriteMaintainAdapter adapter;
    private List<UnderwriteMaintainBean> beans;
    ...
    protected void initData() {
        beans = new ArrayList<>();
        adapter = new UnderwriteMaintainAdapter(mActivity, beans, R.layout.item_underwritemaintain);
    ...
    private void getData() {
        ...
        OkGo.<LzyResponse<UnderwriteMaintainDataBean>>post(Urls.FirstHost+Urls.SecondHost).tag(this)
                .params("params", hexStr)
                .execute(new DialogCallback<LzyResponse<UnderwriteMaintainDataBean>>(mActivity, false) {
                    @Override
                    public void onSuccess(Response<LzyResponse<UnderwriteMaintainDataBean>> response) {
                       if (pageNo == 1) {
                            beans.clear();
                        }
                    ...
                    @Override
                    public void onError(Response<LzyResponse<UnderwriteMaintainDataBean>> response) {
